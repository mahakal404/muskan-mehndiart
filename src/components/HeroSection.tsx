...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* Ambient glow blobs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-cyan-500/10 rounded-full blur-[120px] z-[2] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-600/10 rounded-full blur-[100px] z-[2] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <a
            ...
            className="px-8 py-3.5 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold hover:from-cyan-400 hover:to-blue-400 hover:shadow-[0_0_25px_rgba(34,211,238,0.5)] transition-all duration-300 w-full sm:w-auto"
          >
            Book Your Special Day
          </a>
          <a
            href="#services"
            className="px-8 py-3.5 rounded-full border border-white/20 text-white/80 font-semibold hover:border-cyan-500/50 hover:text-cyan-400 hover:bg-white/5 transition-all duration-300 w-full sm:w-auto"
          >
            Explore Services
          </a>
        </motion.div>
